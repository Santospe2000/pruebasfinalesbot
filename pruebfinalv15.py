...
def generar_grafica_status(status):
    ...
    ax.barh([0], [status], color='blue', height=0.5)
    ax.set_xlim(0, 100)
    ax.set_xticks(range(0, 101, 10))
    ax.set_yticks([])
    ax.set_title("Status de tu posición financiera")
    st.pyplot(fig)
...
def main():
    ...
    if 'usuario' not in st.session_state:
        ...
        tab1, tab2, tab3, tab4 = st.tabs(["Situación Financiera", "Plan de Inversión", "Proyección de Retiro", "Resumen"])
